...
public class tblEmpresa extends javax.swing.JFrame {
    ...
    private void cargarTablaEmpresa(){
        ...
        DefaultTableModel modeloTablaUsu = (DefaultTableModel)tblEmpresa.getModel();
        ...
        try{
            ...
            ps = con.prepareStatement("SELECT id_empresa, Nombre_Empresa,Direccion, Telefono, Correo, Nombre_Material, Cantidad_Material, Pagos FROM empresa");    
            //ejecutar consulta
            rs = ps.executeQuery();
    ...
    public tblEmpresa() {
        ...
        this.setTitle("RECI-CJ (BD-VENTAS)");
    }
    ...
    int filaSeleccionada = tblEmpresa.getSelectedRow();
    if (filaSeleccionada == -1) {
        JOptionPane.showMessageDialog(null, "Selecciona una fila para eliminar");
        return;
    }

    int idEmpresa = (int) tblEmpresa.getValueAt(filaSeleccionada, 0);

    conexion conn = new conexion();
    conn.eliminarEmpresa(idEmpresa);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tblEmpresa().setVisible(true);
            }
        });
    }
